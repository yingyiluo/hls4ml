		  ...
		  unsigned short &const_size_out)
{
    ...
    nnet::tanh<layer1_t, layer1_t, tanh_config1>(logits1, layer1_out);
    ...
    nnet::tanh<layer2_t, layer2_t, tanh_config2>(logits2, layer2_out);
    ...
    nnet::tanh<layer3_t, layer3_t, tanh_config3>(logits3, layer3_out);
    ...
    nnet::compute_layer<layer3_t, layer5_t, config5>(layer3_out, logits5, w5, b5);
    nnet::sigmoid<layer5_t, layer5_t, sigmoid_config5>(logits5, layer5_out);

    nnet::merge<result_t, 1, 1>(layer4_out, layer5_out, res);
