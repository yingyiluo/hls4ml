...
architecture behav of sigmoid is 
    ...
    component sigmoid_sigmoid_tncg IS
    generic (
        DataWidth : INTEGER;
...
begin
    sigmoid_table3_U : component sigmoid_sigmoid_tncg
    generic map (
        DataWidth => 10,
        AddressRange => 1024,
        AddressWidth => 10)
    ...
    sigmoid_table3_address0 <= tmp_s_fu_198_p1(10 - 1 downto 0);

    sigmoid_table3_ce0_assign_proc : process(ap_start, ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_enable_reg_pp0_iter1)
    begin
