...
#ifndef __sigmoid_sigmoid_tncg_H__
#define __sigmoid_sigmoid_tncg_H__
...
struct sigmoid_sigmoid_tncg_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(sigmoid_sigmoid_tncg_ram) {
...
SC_MODULE(sigmoid_sigmoid_tncg) {
...
sigmoid_sigmoid_tncg_ram* meminst;


SC_CTOR(sigmoid_sigmoid_tncg) {
meminst = new sigmoid_sigmoid_tncg_ram("sigmoid_sigmoid_tncg_ram");
