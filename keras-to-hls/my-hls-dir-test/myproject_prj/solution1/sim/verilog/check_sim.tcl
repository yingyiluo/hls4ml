...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.myproject.autotvin_data_0_V.dat"
         "c.myproject.autotvin_data_1_V.dat"
         "c.myproject.autotvin_data_2_V.dat"
         "c.myproject.autotvin_data_3_V.dat"
         "c.myproject.autotvin_data_4_V.dat"
         "c.myproject.autotvin_data_5_V.dat"
         "c.myproject.autotvin_data_6_V.dat"
         "c.myproject.autotvin_data_7_V.dat"
         "c.myproject.autotvin_data_8_V.dat"
         "c.myproject.autotvin_data_9_V.dat"
         "c.myproject.autotvout_res_0_V.dat"
         "c.myproject.autotvout_const_size_in.dat"
         "c.myproject.autotvout_const_size_out.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.myproject.autotvout_res_0_V.dat"
         "rtl.myproject.autotvout_const_size_in.dat"
         "rtl.myproject.autotvout_const_size_out.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
