...
(* CORE_GENERATION_INFO="myproject,hls_ip_2016_4,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xc7vx690tffg1927-2,HLS_INPUT_CLOCK=5.000000,HLS_INPUT_ARCH=pipeline,HLS_SYN_CLOCK=4.330000,HLS_SYN_LAT=17,HLS_SYN_TPT=7,HLS_SYN_MEM=1,HLS_SYN_DSP=51,HLS_SYN_FF=5405,HLS_SYN_LUT=5517}" *)
...
reg   [17:0] logits1_0_V_reg_529;
reg   [17:0] logits1_1_V_reg_534;
reg   [17:0] logits1_2_V_reg_539;
reg   [17:0] logits1_3_V_reg_544;
reg   [17:0] logits1_4_V_reg_549;
reg   [17:0] logits1_5_V_reg_554;
reg   [17:0] logits1_6_V_reg_559;
reg   [17:0] logits1_7_V_reg_564;
reg   [17:0] logits1_8_V_reg_569;
reg   [17:0] logits1_9_V_reg_574;
reg   [17:0] logits1_10_V_reg_579;
reg   [17:0] logits1_11_V_reg_584;
reg   [17:0] logits1_12_V_reg_589;
reg   [17:0] logits1_13_V_reg_594;
reg   [17:0] logits1_14_V_reg_599;
reg   [17:0] logits1_15_V_reg_604;
reg   [17:0] logits1_16_V_reg_609;
reg   [17:0] logits1_17_V_reg_614;
reg   [17:0] logits1_18_V_reg_619;
reg   [17:0] logits1_19_V_reg_624;
reg   [17:0] logits1_20_V_reg_629;
reg   [17:0] logits1_21_V_reg_634;
reg   [17:0] logits1_22_V_reg_639;
reg   [17:0] logits1_23_V_reg_644;
reg   [17:0] logits1_24_V_reg_649;
reg   [17:0] logits1_25_V_reg_654;
reg   [17:0] logits1_26_V_reg_659;
reg   [17:0] logits1_27_V_reg_664;
reg   [17:0] logits1_28_V_reg_669;
reg   [17:0] logits1_29_V_reg_674;
reg   [17:0] logits1_30_V_reg_679;
reg   [17:0] logits1_31_V_reg_684;
reg   [17:0] layer1_out_0_V_reg_689;
reg   [17:0] layer1_out_1_V_reg_694;
reg   [17:0] layer1_out_2_V_reg_699;
reg   [17:0] layer1_out_3_V_reg_704;
reg   [17:0] layer1_out_4_V_reg_709;
reg   [17:0] layer1_out_5_V_reg_714;
reg   [17:0] layer1_out_6_V_reg_719;
reg   [17:0] layer1_out_7_V_reg_724;
reg   [17:0] layer1_out_8_V_reg_729;
reg   [17:0] layer1_out_9_V_reg_734;
reg   [17:0] layer1_out_10_V_reg_739;
reg   [17:0] layer1_out_11_V_reg_744;
reg   [17:0] layer1_out_12_V_reg_749;
reg   [17:0] layer1_out_13_V_reg_754;
reg   [17:0] layer1_out_14_V_reg_759;
reg   [17:0] layer1_out_15_V_reg_764;
reg   [17:0] layer1_out_16_V_reg_769;
reg   [17:0] layer1_out_17_V_reg_774;
reg   [17:0] layer1_out_18_V_reg_779;
reg   [17:0] layer1_out_19_V_reg_784;
reg   [17:0] layer1_out_20_V_reg_789;
reg   [17:0] layer1_out_21_V_reg_794;
reg   [17:0] layer1_out_22_V_reg_799;
reg   [17:0] layer1_out_23_V_reg_804;
reg   [17:0] layer1_out_24_V_reg_809;
reg   [17:0] layer1_out_25_V_reg_814;
reg   [17:0] layer1_out_26_V_reg_819;
reg   [17:0] layer1_out_27_V_reg_824;
reg   [17:0] layer1_out_28_V_reg_829;
reg   [17:0] layer1_out_29_V_reg_834;
reg   [17:0] layer1_out_30_V_reg_839;
reg   [17:0] layer1_out_31_V_reg_844;
wire   [17:0] grp_compute_layer_0_0_fu_169_ap_return;
reg   [17:0] logits2_0_V_reg_849;
...
wire    grp_compute_layer_0_0_fu_169_ap_start;
wire    grp_compute_layer_0_0_fu_169_ap_done;
wire    grp_compute_layer_0_0_fu_169_ap_idle;
wire    grp_compute_layer_0_0_fu_169_ap_ready;
...
reg    ap_reg_grp_compute_layer_0_0_fu_169_ap_start;
...
#0 ap_reg_grp_compute_layer_0_0_fu_169_ap_start = 1'b0;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ap_reg_grp_compute_layer_0_0_fu_169_ap_start <= 1'b0;
    end else begin
        if (((ap_CS_fsm_pp0_stage0 == 1'b1) & ~((1'b1 == ap_enable_reg_pp0_iter0) & (ap_start == 1'b0)) & (1'b1 == ap_enable_reg_pp0_iter1))) begin
            ap_reg_grp_compute_layer_0_0_fu_169_ap_start <= 1'b1;
        end else if ((1'b1 == grp_compute_layer_0_0_fu_169_ap_ready)) begin
            ap_reg_grp_compute_layer_0_0_fu_169_ap_start <= 1'b0;
        end
    end
end
...
assign grp_compute_layer_0_0_fu_169_ap_start = ap_reg_grp_compute_layer_0_0_fu_169_ap_start;
