...
struct conv_config
{
    ...
    static const unsigned y_sub_out = 64;
	     ...
	     typename CONFIG_T::bias_t    biases[CONFIG_T::n_filt])
{
    ...
    typename CONFIG_T::accum_t mult[CONFIG_T::y_sub_out * CONFIG_T::n_filt * CONFIG_T::n_chan * CONFIG_T::y_filt];
    typename CONFIG_T::accum_t acc[CONFIG_T::y_sub_out * CONFIG_T::n_filt];
    ...
    ConvOut: for(int ii = 0; ii < CONFIG_T::y_sub_out; ii++) {
    ...
    for(int ii = 0; ii < CONFIG_T::y_out; ii++) {
		for(int ff = 0; ff < CONFIG_T::n_filt; ff++) {
                acc[ii*CONFIG_T::n_filt+ff]=biases[ff];
		}
    }
        ...
        AccumFilt: for(int ff = 0; ff < CONFIG_T::n_filt; ff++) {
            ...
            AccumChan: for(int cc = 0; cc < CONFIG_T::n_chan; cc++){
			    AccumDot: for(int jj = 0; jj < CONFIG_T::y_filt; jj++){
                    int index_mult = ii*CONFIG_T::n_filt*CONFIG_T::n_chan*CONFIG_T::y_filt + ff*CONFIG_T::n_chan*CONFIG_T::y_filt + cc*CONFIG_T::y_filt + jj;
		    		acc[ii*CONFIG_T::n_filt+ff] += mult[index_mult];
    ...
    for(int ii = 0; ii < CONFIG_T::y_out; ii++) {
		for(int ff = 0; ff < CONFIG_T::n_filt; ff++) {
	    	res[ii][ff] = (res_T)(acc[ii*CONFIG_T::n_filt+ff]);
		}
    }
}
